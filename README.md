...
* We Establish a Baseline Performance.
* We Tune the Baseline Trading Algorithm.
* We Evaluate a New Machine Learning Classifier and Create.
* We Create an Evaluation Report.
